-- Henri — fix: seed functions must bypass RLS when called from the
-- after-insert trigger, because the caregiver row doesn't exist yet
-- at the moment the baby row is created.
--
-- Run this once in the Supabase SQL editor after 01–04. Self-contained.
